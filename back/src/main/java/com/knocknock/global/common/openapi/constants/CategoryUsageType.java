...
public enum CategoryUsageType {
    ...
    공기청정기("공기청정기","CONS_PWR", "STANDARD_CONS_AREA", null, null),
//    전기밥솥("전기밥솥", "", "", "", ""), // 달라요
    ...
    전기냉온수기("전기냉온수기", "MONTH_CONS_PWR", null, null, null),
    전기냉장고("전기냉장고", "MONTH_CONS_PWR", "CAPA", null, null),
    전기레인지("전기레인지", "UNIT_CONS_PWR", null, null, null),
    전기냉방기("전기냉방기", "MONTH_CONS_PWR1", null, "EFFIC1", null),
    텔레비전수상기("텔레비전수상기", null, "R", null, null),
//    정기냉난방기("전기냉난방기", "MON_CONS_PWR", "COOL_EFFIC", "PROP_COOL_PWR", null),
